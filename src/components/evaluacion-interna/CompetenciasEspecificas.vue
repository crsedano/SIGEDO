...
export default {
  ...
  methods: {
    ...
    async setRedaccion ({ id }) {
      ...
      try {
        const { status } = await this.axios.post(`${this.URL_}2/evaluacion-interna/redaccion-especifico/${id}`)
    ...
    async setAlfa ({ id }) {
      ...
      try {
        const { status } = await this.axios.post(`${this.URL_}2/evaluacion-interna/alfa-especifico/${id}`)
    ...
    async setBeta ({ id }) {
      ...
      try {
        const { status } = await this.axios.post(`${this.URL_}2/evaluacion-interna/beta-especifico/${id}`)
    ...
    async setGama ({ id }) {
      ...
      try {
        const { status } = await this.axios.post(`${this.URL_}2/evaluacion-interna/gama-especifico/${id}`)
