...
<div class="ed-container init sub-main">
  ...
  <div v-else class="ed-item m-60 sep-10 to-center ed-container sep-10 table-content">
...
export default {
  ...
  methods: {
    ...
    crearUniversidad: function () {
      this.universidad.cuniversidad = this.toNomProp(this.universidad.cuniversidad)
