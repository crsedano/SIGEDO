...
<div class="ed-container">
    ...
    <div class="ed-item sep-10">
      <el-table border stripe fit :data="info" height="250" highlight-current-row :row-class-name="tableRowClassName">
        ...
        <el-table-column prop="carpeta" label="Didactica Superior" min-width="80" align="center" header-align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    async getData () {
      try {
        const res = await this.axios.get(`${this.URL_}v2/evaluacion_docente/rubro_6/${this.idDocente}`)
        if (res.status === 200) {
