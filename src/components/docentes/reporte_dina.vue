...
<div class="ed-container init">
  ...
  <div v-if="arrData" class="ed-item txt-center">
    <a v-if="entorno" target="_blank" :href="`${URLPDF}api/src/reportes/docentes/reporte_dina.php?ae_bcd=${token}&id_periodo=${periodo.id_periodo}&id_semestre=${periodo.id_semestre}&id_filial=${id_filial}&id_modalidad=${id_modalidad}&id_facultad=${id_facultad}&id_escuela=${id_escuela}&id_usuario=${this.identity.id_usuario}`"
...
export default {
  ...
  methods: {
    ...
    getDataReporte: async function () {
      ...
      const res = await gxDocente.getDocentesDina(this.autho, id_periodo, id_semestre, id_filial, id_modalidad, id_facultad, id_escuela)
