<template>
  <div class="ed-container init no-imp">
    <h2 class="ed-item sep-10 gr-center">
      <strong>RESOLUCIÓN CONSEJO UNIVERSITARIO</strong>
    </h2>
    ...
    <div class="ed-item m-80 l-60 to-center sep-40 ed-container">
      ...
      <div class="ed-item sep-10 m-50 form-group">
        ...
        <select :disabled="!general_" v-model="dedicacion" class="form-control">
    ...
    <div class="ed-item ed-container sep-10 to-center">
      <div class="ed-item sep-10 m-50 l-30 form-group">
        <label>N° Resolución</label>
        <input
          v-model="impresion.numeroResolucion"
          type="text"
          class="form-control"
      ...
      <div class="ed-item sep-10 m-50 l-30 form-group">
        ...
        <input
          v-model="impresion.fechaResolucion"
          type="text"
          class="form-control"
          placeholder="RESOLUCION"
        />
      ...
      <div class="ed-item sep-10 m-50 l-30 form-group">
        <label>Sesión</label>
        <select v-model="impresion.sesion" class="form-control">
      ...
      <div class="ed-item sep-10 m-50 l-30 form-group">
        ...
        <select v-model="impresion.docente" class="form-control">
          <option value="ORDINARIOS">ORDINARIOS</option>
          <option value="CONTRATADOS">CONTRATADOS</option>
          <option value="JEFE DE PRACTICA">JEFE DE PRACTICA</option>
          <option value="TODOS">TODOS</option>
        </select>
      </div>

      <div class="ed-item sep-10 m-50 l-30 form-group">
        <label>N° Resolución CF</label>
        <input v-model="impresion.numeroResolucionCf" type="text" class="form-control" />
      </div>

      <div class="ed-item sep-10 m-50 l-30 form-group">
        <label>Fecha Resolución CF</label>
        <input v-model="impresion.fechaResolucionCf" type="text" class="form-control" />
      </div>

      <div class="ed-item sep-10 m-50 l-30 form-group">
        <label>Sede / Filial</label>
        <select v-model="impresion.sede" class="form-control">
          <option value="SEDE CENTRAL HUANCAYO">SEDE CENTRAL HUANCAYO</option>
          <option value="FILIAL LIMA">FILIAL LIMA</option>
          <option value="FILIAL CHANCHAMAYO">FILIAL CHANCHAMAYO</option>
        </select>
      </div>

      <div class="ed-item sep-10 m-50 l-30 form-group">
        <label>Modalidad</label>
        <select v-model="impresion.modalidad" class="form-control">
      ...
      <div class="ed-item sep-10 m-50 l-30 form-group">
        ...
        <input v-model="impresion.semestreAcademico" type="text" class="form-control" />
      </div>

      <div class="ed-item sep-10 m-50 l-30 form-group">
        <label>N° Oficio</label>
        <input v-model="impresion.numeroOficio" type="text" class="form-control" />
      </div>

      <div class="ed-item sep-10 m-50 l-30 form-group">
        <label>Fecha Oficio</label>
        <input v-model="impresion.fechaOficio" type="text" class="form-control" />
      </div>

      <div class="ed-item sep-10 m-50 l-30 form-group">
        <label>Decano / Encargado</label>
        <input v-model="impresion.decano" type="text" class="form-control" />
      </div>

      <div class="ed-item sep-10 m-50 l-30 form-group">
        <label>N° Expediente</label>
        <input v-model="impresion.numeroExpediente" type="text" class="form-control" />
      </div>

      <div class="ed-item sep-10 m-50 l-30 form-group">
        <label>N° Proveido</label>
        <input v-model="impresion.numeroProveido" type="text" class="form-control" />
      </div>

      <div class="ed-item sep-10 m-50 l-30 form-group">
        <label>Fecha Proveido</label>
        <input v-model="impresion.fechaProveido" type="text" class="form-control" />
      </div>
    </div>
    ...
    <div class="ed-item m-60 to-center ed-container">
      ...
      <div v-if="dataDocentePresencial.length > 0" class="ed-item m-50 to-center gr-center">
        ...
        <a
          v-if="entorno!=null && id_modalidad == 1 && !plazaDesierta"
          class="btn btn-dark btn-rounded"
          target="_blank"
          :href="`${URLPDF}api/src/Reports/resoluciones-presencial/Resolucion.php?version=${entorno.version_ingreso}&id_periodo=${periodo.id_periodo}&id_semestre=${periodo.id_semestre}&id_docente=${id_docente}&id_filial=${id_filial}&id_facultad=${id_facultad}&id_escuela=${id_escuela}&dedicacion=${dedicacion}&resolucion=${resolucion}&cargo=${cargo}&id_usuario=${identity.id_usuario}&curso=${curso}&numeroResolucion=${impresion.numeroResolucion}&fechaResolucion=${impresion.fechaResolucion}&sesion=${impresion.sesion}&fechaSesion=${impresion.fechaSesion}&facultad=${impresion.facultad}&docente=${impresion.docente}&numeroResolucionCf=${impresion.numeroResolucionCf}&fechaResolucionCf=${impresion.fechaResolucionCf}&sede=${impresion.sede}&modalidad=${impresion.modalidad}&semestreAcademico=${impresion.semestreAcademico}&numeroOficio=${impresion.numeroOficio}&fechaOficio=${impresion.fechaOficio}&decano=${impresion.decano}&numeroExpediente=${impresion.numeroExpediente}&numeroProveido=${impresion.numeroProveido}&fechaProveido=${impresion.fechaProveido}`"
        >
          <i class="fas fa-file-pdf"></i>
          Imprimir Resolucion
        </a>
        ...
        <a
          v-if="entorno!=null && id_modalidad == 2 && !plazaDesierta"
          class="btn btn-dark btn-rounded"
          target="_blank"
          :href="`${URLPDF}api/src/Reports/resoluciones-semipresencial/Resolucion.php?version=${entorno.version_ingreso}&id_periodo=${periodo.id_periodo}&id_semestre=${periodo.id_semestre}&id_docente=${id_docente}&id_filial=${id_filial}&id_facultad=${id_facultad}&id_escuela=${id_escuela}&dedicacion=${dedicacion}&resolucion=${resolucion}&cargo=${cargo}&id_usuario=${identity.id_usuario}&curso=${curso}&numeroResolucion=${impresion.numeroResolucion}&fechaResolucion=${impresion.fechaResolucion}&sesion=${impresion.sesion}&fechaSesion=${impresion.fechaSesion}&facultad=${impresion.facultad}&docente=${impresion.docente}&numeroResolucionCf=${impresion.numeroResolucionCf}&fechaResolucionCf=${impresion.fechaResolucionCf}&sede=${impresion.sede}&modalidad=${impresion.modalidad}&semestreAcademico=${impresion.semestreAcademico}&numeroOficio=${impresion.numeroOficio}&fechaOficio=${impresion.fechaOficio}&decano=${impresion.decano}&numeroExpediente=${impresion.numeroExpediente}&numeroProveido=${impresion.numeroProveido}&fechaProveido=${impresion.fechaProveido}`"
        >
          <i class="fas fa-file-pdf"></i>
          Imprimir Resolucion
        </a>
    ...
    >
      <table class="main-table">
        <thead class="table-head">
          ...
          <tr>
            <th class="center" colspan="25">RESOLUCIÓN CONSEJO DE FACULTAD</th>
          </tr>
          <tr>
            <th
              class="center"
  ...
  data: function() {
    return {
      ...
      impresion: {
        ...
        facultad: null,
        docente: null,
        numeroResolucionCf: null,
        fechaResolucionCf: null,
        sede: null,
        modalidad: null,
