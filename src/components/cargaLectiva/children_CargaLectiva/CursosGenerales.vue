...
<div class="ed-container init">
  ...
  <div class="ed-item">
    <el-table @row-click="tableEvent" border stripe fit :data="cursosGenFilter" height="460" highlight-current-row :row-class-name="tableRowClassName">
  ...
  methods: {
    ...
    tableEvent (curso, column, event) {
      if(this.periodo.estado != 1) {
        this.swAlert(`Este periodo no esta activo`, 'error')
        return
      }
