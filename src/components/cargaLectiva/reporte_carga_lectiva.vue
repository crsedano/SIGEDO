<template>
  <div class="ed-container init no-imp">
    <h2 class="ed-item sep-10 gr-center">
      <strong>REPORTE CARGA LECTIVA</strong>
    </h2>
    ...
    <div class="ed-item m-80 l-60 to-center sep-40 ed-container">
      ...
      <div v-if="!general_" class="ed-item sep-10 m-50 form-group">
        <label>Dedicación por horas</label>
        <select v-model="dedicacion_" class="form-control">
          <option value="T">TODOS</option>
          <option value="TC">TC</option>
          <option value="TP">TP</option>
          <option value="DE">DE</option>
    ...
    <div class="ed-item m-60 to-center ed-container">
      ...
      <div v-if="dataDocentePresencial.length > 0" class="ed-item m-50 to-center gr-center">
        <a
          ...
          target="_blank"
          :href="`${URLPDF}api/src/reportes/carga_lectiva/presencial.php?ae_bcd=${token}&version=${entorno.version_ingreso}&id_periodo=${periodo.id_periodo}&id_semestre=${periodo.id_semestre}&id_docente=${id_docente}&id_filial=${id_filial}&id_facultad=${id_facultad}&id_escuela=${id_escuela}&dedicacion=${dedicacion}&cargo=${cargo}&id_usuario=${identity.id_usuario}&curso=${curso}&dedi=${dedicacion_}`"
        >
        ...
        <a
          ...
          class="btn btn-dark btn-rounded"
          target="_blank"
          :href="`${URLPDF}api/src/reportes/carga_lectiva/semipresencial.php?ae_bcd=${token}&version=${entorno.version_ingreso}&id_periodo=${periodo.id_periodo}&id_semestre=${periodo.id_semestre}&id_docente=${id_docente}&id_filial=${id_filial}&id_facultad=${id_facultad}&id_escuela=${id_escuela}&dedicacion=${dedicacion}&cargo=${cargo}&id_usuario=${identity.id_usuario}&curso=${curso}&dedi=${dedicacion_}`"
        >
          <i class="fas fa-file-pdf"></i>
          Imprimir
        </a>
        <a
          ...
          class="btn btn-dark btn-rounded"
          target="_blank"
          :href="`${URLPDF}api/src/reportes/carga_lectiva_sp.php?ae_bcd=${token}&version=${entorno.version_ingreso}&id_periodo=${periodo.id_periodo}&id_semestre=${periodo.id_semestre}&id_docente=${id_docente}&id_filial=${id_filial}&id_facultad=${id_facultad}&id_escuela=${id_escuela}&dedicacion=${dedicacion}&cargo=${cargo}&id_usuario=${identity.id_usuario}&curso=${curso}&dedi=${dedicacion_}`"
        >
          <i class="fas fa-file-pdf"></i>
          Imprimir
        </a>
        <!-- <a v-if="entorno!=null && id_modalidad == 2 && resolucion != ''" class="btn btn-dark btn-rounded" target="_blank"
        :href="`${URLPDF}api/src/reportes/carga_lectiva/resolucion_semipresencial.php?ae_bcd=${token}&version=${entorno.version_ingreso}&id_periodo=${periodo.id_periodo}&id_semestre=${periodo.id_semestre}&id_docente=${id_docente}&id_filial=${id_filial}&id_facultad=${id_facultad}&id_escuela=${id_escuela}&dedicacion=${dedicacion}&resolucion=${resolucion}&cargo=${cargo}&id_usuario=${identity.id_usuario}&curso=${curso}`">
        <i class="fas fa-file-pdf"></i>
        Imprimir Resolucion
        </a>-->
      ...
      <table class="main-table">
        ...
        <tbody class="table-body">
          <template v-for="(data, index) in dataDocentePresencial">
            <template
              v-if="dedicacion_ == 'T' ? true : calcularDatosLectiva(data).dedicacion == dedicacion_"
            >
              <tr :key="index">
                ...
                <!-- <td class="-100" :rowspan="data.cursos.length">{{data.horas_administrativas_upla}}</td> -->
                <!-- <td class="-100" :rowspan="data.cursos.length">{{parseInt(data.suma_sub_total) > 20 ? 40 - parseInt(data.suma_sub_total) : 0}}</td> -->
                ...
                <!-- <td class="-100" :rowspan="data.cursos.length">{{parseInt(data.suma_sub_total) > 20 ? 40 : data.suma_sub_total}} </td> -->
                <!-- <td class="-100" :rowspan="data.cursos.length">{{parseInt(data.suma_sub_total) > 20 ? 'TC' : 'TP'}}</td> -->
              </tr>
    ...
    >
      <table class="main-table">
        ...
        <tbody class="table-body">
          <template v-for="(data, index) in dataDocentePresencial">
            <template
              v-if="dedicacion_ == 'T' ? true : calcularDatosLectivaSP(data).dedicacion == dedicacion_"
            >
              <tr :key="index">
                ...
                <!-- <td :rowspan="data.cursos.length">{{data.horas_administrativas_upla}}</td> -->
                <!-- <td :rowspan="data.cursos.length">{{(parseInt(data.suma_sp) + parseInt(data.suma_sv)) > 20 ? 40 : 0}}</td> -->
                ...
                <td
                  :rowspan="data.cursos.length"
                >{{parseInt(data.suma_sp) + parseInt(data.suma_sv)}}</td>
                <!-- <td :rowspan="data.cursos.length">{{parseInt(data.tot_hlectivas) + parseInt(data.horas_administrativas_upla)}}</td> -->
                <!-- <td :rowspan="data.cursos.length">{{data.dedicacion_upla}}</td> -->
                <td :rowspan="data.cursos.length">{{calcularDatosLectivaSP(data).dedicacion}}</td>
                <!-- <td :rowspan="data.cursos.length">{{(parseInt(data.suma_sp) + parseInt(data.suma_sv)) > 20 ? 'TC' : 'TP'}}</td> -->
              </tr>
              <tr v-if="ind != 0" v-for="(d, ind) in data.cursos" :key="ind * 100000 + index">
