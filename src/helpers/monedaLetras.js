export default class MonedaLetas {
    Unidades(num) {
        switch (num) {
            case 1:
                return 'UN';
    ...
    Decenas(num) {
        ...
        NumeroALetras(num, currency) {
            ...
            if (data.centavos > 0) {
                data.letrasCentavos = 'CON ' + this.Millones(data.centavos) + ' ' + (data.centavos == 1 ? data.letrasMonedaCentavoSingular : data.letrasMonedaCentavoPlural)
            }
